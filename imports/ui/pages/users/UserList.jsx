...
function UserList({users}) {
  ...
  const actionButton = id =>(<><Link to={`${RoutesMap.get(UserProfile).replace(":id","")}${id}`} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded"><i className="far fa-edit"/></Link></>);
  return (
    <AdminContainer>
